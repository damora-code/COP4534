...
public class Algorithms
{
    ...
    private static void randomizedQuickSort(int[] list, int begin, int end)
    {
        int temp;
        ...
        if (begin < i - 1) randomizedQuickSort(list, begin, i - 1);
        if (i + 1 < end) randomizedQuickSort(list, i + 1, end);
    }
